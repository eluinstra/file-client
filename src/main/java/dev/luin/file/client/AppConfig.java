...
@Import({DataSourceConfig.class, DownloadClientConfig.class, FileSystemConfig.class, KeyStoreConfig.class, QueryDSLConfig.class, ServiceConfig.class,
		TransactionManagerConfig.class, UploadClientConfig.class, WebConfig.class})
@PropertySource(
		value = {"classpath:dev/luin/file/client/core/default.properties", "classpath:dev/luin/file/client/default.properties",
				"file:${configDir}file-client.advanced.properties", "file:${configDir}file-client.properties"},
...
public class AppConfig
{
	...
	private static PropertySourcesPlaceholderConfigurer propertySourcesPlaceholderConfigurer()
	{
		...
		val resources =
				new Resource[]{new ClassPathResource("dev/luin/file/client/core/default.properties"), new ClassPathResource("dev/luin/file/client/default.properties"),
